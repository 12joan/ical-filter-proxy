module IcalFilterProxy
  class Calendar
    attr_accessor :ical_url, :api_key, :filter_rules, :alarms

    def initialize(ical_url, api_key)
    ...
    def add_alarm(options)
      self.alarms << Alarm.new(options)
    end
